...
import { Button, GenericHeader, SizableText, Text, YStack } from '@tloncorp/ui';
    ...
    <ScrollView style={{ flex: 1 }}>
      <YStack gap="$xl" padding="$xl">
        ...
        <SizableText>
          ...
          the "I Agree" button, downloading or using Tlon.
        </SizableText>
        ...
        <SizableText>
          ...
          Play Store) by which the Application has been downloaded to your
          Device.
        </SizableText>

        <SizableText>
          "Company" (referred to as either "the Company", "We", "Us" or "Our" in
          this Agreement) refers to Tlon Corporation, 2325 3rd St, San
          Francisco, CA 94107
        </SizableText>
        <SizableText>
        ...
        <SizableText>"Country" refers to: United States</SizableText>
        <SizableText>
          "Device" means any device that can access the Application such as a
          computer, a cellphone or a digital tablet.
        </SizableText>
        <SizableText>
          "Family Sharing / Family Group" permits You to share applications
          downloaded through the Application Store with other family members by
          allowing them to view and download each others' eligible Applications
        ...
        <SizableText>
          ...
          the Application and its content. Although the Application Store is not
          a party to this Agreement, it has the right to enforce it against You
        ...
        <SizableText>
          ...
          example, Family Sharing / Family Group or volume purchasing, the use
          of the Application by those users is expressly subject to this
          Agreement.
        </SizableText>
        ...
        <SizableText>
          ...
          &ldquo;objectionable content&rdquo; shall mean any information, data,
          text, images, videos, sounds, or other material that:
        </SizableText>
        ...
        <SizableText>
          c. Is violent or threatening, or promotes violence or actions that are
        ...
        <SizableText>
          Indemnity: The User agrees to indemnify and hold harmless The Company
          and its affiliates, officers, agents, and employees from any claim or
          demand, including reasonable attorneys&rsquo; fees, made by any third
          party due to or arising out of the User&rsquo;s violation of this
          section, or the User&rsquo;s violation of any law or the rights of a
          third party related to objectionable content or abusive behavior.
        </SizableText>

        <SizableText>
          Revisions: The Company reserves the right to revise the criteria for
          objectionable content or abusive behavior at any time and will notify
          users of any changes to this policy.
        </SizableText>
        ...
        <SizableText>
          ...
          through the Application or 100 USD if You haven&rsquo;t purchased
        ...
        <SizableText>
          ...
          You under any theory of liability for any direct, indirect,
        ...
        <SizableText>
          If you have any questions about this Agreement, You can contact us by
          sending us an email: into@tlon.io
        </SizableText>
      </YStack>
    </ScrollView>
  );
