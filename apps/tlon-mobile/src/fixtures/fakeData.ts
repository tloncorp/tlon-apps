...
export const createSimpleContent = (str: string): Story => {
  return [
    {
      inline: [str],
    },
...
export const createImageContent = (url: string): Story => {
  return [
    {
      block: {
        image: {
...
export const createMentionContent = (contactId: string): Story => {
  return [
    {
      inline: [
        {
...
export const createCodeContent = (code: string): Story => {
  return [
    {
      inline: [
        {
...
export const createBlockquoteContent = (str: string, str2?: string): Story => {
  return [
    {
      inline: [
        {
...
const getRandomFakeContent = (): api.PostContent => {
