...
export const fixtureCatalog = {
  'chat-v1': {
    description:
      'Disposable ~zod/~ten ships with a unique group and writable chat channel. Use only when a scenario needs another ship. A peer message is verified on ~zod before launch. The device agent may send and edit its own messages inside this exact chat, including multiline text and code blocks. Does not provide large history, DMs, or controlled event timing.',
