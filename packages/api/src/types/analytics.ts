export enum AnalyticsEvent {
  ...
  ChatListItemSelected = 'Chat List Item Selected',
  GroupChannelSelected = 'Group Channel Selected',
  ActivityDestinationSelected = 'Activity Destination Selected',
  ...
  MediaPlaybackStarted = 'Media Playback Started',
  ThreadOpened = 'Thread Opened',
  GalleryPostOpened = 'Gallery Post Opened',
  NotebookPostOpened = 'Notebook Post Opened',
  ...
  InviteShareCompleted = 'Invite Share Completed',
  InviteOpened = 'Invite Opened',
  InviteRedeemed = 'Invite Redeemed',
  GroupInvitationsSent = 'Group Invitations Sent',
  GroupCreationCompleted = 'Group Creation Completed',
  ChannelCreationCompleted = 'Channel Creation Completed',
  ProfileUpdateCompleted = 'Profile Update Completed',
  ForwardCompleted = 'Forward Completed',
