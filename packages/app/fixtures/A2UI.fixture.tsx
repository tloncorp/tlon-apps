...
const nestedCardA2UI: PostBlobDataEntryA2UI = {
  type: 'a2ui',
  version: 1,
  messages: [
    {
      ...
      updateComponents: {
        ...
        components: [
          { id: 'root', component: 'Card', child: 'body' },
          {
            id: 'body',
            component: 'Column',
            children: ['eyebrow', 'title', 'copy', 'summaryCard', 'actions'],
          },
          {
            id: 'eyebrow',
            component: 'Text',
          ...
          },
          {
            id: 'copy',
            component: 'Text',
            text: 'A sub-card can group related details inside a larger message.',
          },
          { id: 'summaryCard', component: 'Card', child: 'summaryBody' },
          {
            id: 'summaryBody',
            component: 'Column',
            children: ['summaryTitle', 'summaryDivider', 'summaryRows'],
          },
          {
            id: 'summaryTitle',
            component: 'Text',
          ...
          { id: 'summaryDivider', component: 'Divider' },
          {
            id: 'summaryRows',
            component: 'Column',
            children: ['summaryOne', 'summaryTwo', 'summaryThree'],
          },
          {
            id: 'summaryOne',
            component: 'Text',
            text: 'Weather card refresh',
          },
          {
            id: 'summaryTwo',
            component: 'Text',
            text: 'DM approval prompt',
          },
          {
            id: 'summaryThree',
            component: 'Text',
            text: 'Basic component catalog',
          },
          {
            id: 'actions',
            component: 'Row',
            children: ['acknowledge', 'details'],
          },
          {
            id: 'acknowledge',
            component: 'Button',
            variant: 'primary',
            child: 'acknowledgeLabel',
            action: {
              event: {
                name: 'tlon.sendMessage',
                context: { text: 'acknowledge release summary' },
              },
            },
          },
          { id: 'acknowledgeLabel', component: 'Text', text: 'Acknowledge' },
          {
            id: 'details',
            component: 'Button',
            child: 'detailsLabel',
            action: {
              event: {
                name: 'tlon.sendMessage',
                context: { text: 'show release details' },
              },
            },
          },
          { id: 'detailsLabel', component: 'Text', text: 'Details' },
        ],
      },
    },
  ],
...
const nestedCardPost = makePost(
  exampleContacts.groupAdmin,
  [verse.inline('Release summary with nested card.')],
  { blob: appendToPostBlob(undefined, nestedCardA2UI), replyCount: 0 }
);
