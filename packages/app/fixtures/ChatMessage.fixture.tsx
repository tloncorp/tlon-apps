...
export default {
  ...
  MusicTrack: <SinglePostFixture post={postWithMusicTrack} />,
  MusicRelease: <SinglePostFixture post={postWithMusicRelease} />,
  MusicPlaylist: <SinglePostFixture post={postWithMusicPlaylist} />,
