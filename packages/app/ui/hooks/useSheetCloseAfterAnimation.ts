...
// Wait for BottomSheetWrapper's native dismiss animation to complete before
// running a follow-up action (unmounting the React tree, or closing a parent
// sheet). On web there is no native modal teardown, so close immediately;
...
/**
 * Defers a close-related action until a native bottom sheet has had time to
