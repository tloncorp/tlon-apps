...
moon, OpenClaw turn, reply dispatch, and owner-side persistence. See the
[message journey event contract and Grafana alert query](docs/message-journey-observability.md).
