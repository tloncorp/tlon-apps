...
/**
 * Makes the specified properties of an object type optional.
 *
 * ```ts
 * Optional<{a: number, b: string, c?: symbol}, 'a'>
 * // {a?: number, b: string, c?: symbol}
 * ```
 */
export type Optional<Base, OptionalProperties extends keyof Base> = Omit<
  Base,
  OptionalProperties
> &
