...
export const themes = {
  ...
  dracula: {
    ...
    systemNoticeBackground: '#44475A',
    systemNoticeBorder: '#BD93F9',
    systemNoticeText: '#F8F8F2',
    mediaScrim: tokens.color.mediaScrim.val,
  },
  gruvbox: {
    primaryText: '#ebdbb2',
    ...
    systemNoticeBackground: '#458588',
    systemNoticeBorder: '#83a598',
    systemNoticeText: '#ebdbb2',
    mediaScrim: tokens.color.mediaScrim.val,
  },
  monokai: {
    primaryText: '#F8F8F2',
    ...
    systemNoticeBackground: '#66D9EF',
    systemNoticeBorder: '#A6E22E',
    systemNoticeText: '#272822',
    mediaScrim: tokens.color.mediaScrim.val,
  },
  solarized: {
    primaryText: '#839496',
    ...
    systemNoticeBackground: '#268bd2',
    systemNoticeBorder: '#2aa198',
    systemNoticeText: '#fdf6e3',
    mediaScrim: tokens.color.mediaScrim.val,
  },
  nord: {
    primaryText: '#ECEFF4',
    ...
    systemNoticeBackground: '#5E81AC',
    systemNoticeBorder: '#81A1C1',
    systemNoticeText: '#ECEFF4',
    mediaScrim: tokens.color.mediaScrim.val,
  },
  greenscreen: {
    primaryText: '#00ff00',
    ...
    systemNoticeBackground: '#003300',
    systemNoticeBorder: '#00ff00',
    systemNoticeText: '#00ff00',
    mediaScrim: tokens.color.mediaScrim.val,
  },
  peony: {
    primaryText: '#d14790',
    ...
    systemNoticeBackground: '#4a9f2c',
    systemNoticeBorder: '#91d670',
