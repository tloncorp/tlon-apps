...
export const DrawingInput = ({
  ...
  const { attachAssets, attachments } = useAttachmentContext();
...
export const StandaloneDrawingInput: DrawingInputComponent = ({
  draftInputContext: { channel, send: onSend },
}) => {
...
export default StandaloneDrawingInput;
