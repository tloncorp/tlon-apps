...
TLON_TOOL_DESCRIPTION = (
    ...
    "notes/~host/name nests) — the right place for durable writing such as "
    "meeting notes, drafts, and reference documents. Notebooks are not "
    "message channels: never posts send to a notes/ nest. For notes bodies, "
    "use --body <file> "
