...
When using Codex with the Playwright MCP server for e2e testing:
...
-   **No persistent auth state**: MCP server does not maintain authentication across Codex instances
