...
++  uv-posts-1
  ...
  [id-post ?:(?=(%| -.v-post) ~ `(uv-post-1 +.v-post))]
::
++  uv-posts-2
  |=  =v-posts:c
  ^-  posts:v8:old:c
  ...
  [id-post ?:(?=(%| -.v-post) ~ `(uv-post-2 +.v-post))]
::
++  uv-posts-3
  |=  =v-posts:c
  ^-  posts:v9:old:c
...
++  s-replies-2
  ...
  ^-  (unit [id-reply:c simple-reply:old:v8:c])
  ?:  ?=(%| -.reply)  ~
