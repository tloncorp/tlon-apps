...
++  agent
  ...
  ++  agent
    ...
    ++  on-poke
      ...
      ::
      :: =+  !<(=egg-any:gall vase)
      :: =/  =egg:gall  ::TODO  want a +next-egg helper or w/e
      ::   |-  !:
      ::   ?-  -.egg-any
      ::     %15  ~!  egg-any  $(egg-any egg-any(- %16, ken [ken.egg-any pen=~ gem=~]))
      ::     %16  ~!  egg-any  $(egg-any egg-any(- %20, +.old-state (next-vase:h136 +.old-state.egg-any)))
      ::     %20  +.egg-any
      ::   ==
      :: =/  =cage  !:
      ::   :-  mark
      ...
      ::   %=  +.egg
      ::     +.old-state  :-  -:!>(**)  ::NOTE  hack
      ::                  ::  strip carefully, old versions will have
