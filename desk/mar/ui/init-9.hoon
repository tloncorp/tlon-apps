...
++  grow
  ...
  ++  json
    ...
    :~  groups/(groups-ui:v11:enjs:gj groups.init)
        ...
        activity/(activity:v9:enjs:aj activity.init |)
        pins/a/(turn pins.init whom:enjs:gj)
        profile/b/profile.init
      ::
        :-  %channels
        %-  pairs
        :~  channels/(channels:v11:enjs:dj channels.channels.init)
            hidden-posts/(hidden-posts:v10:enjs:dj hidden-posts.channels.init)
        ==
      ::
        :-  %chat
        %-  pairs
