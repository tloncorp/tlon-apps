...
++  poke
  ...
  ?+    mark  ~|(bad-mark+mark !!)
    ...
    ::
      ...
      %+  roll  a-group-list
      |=  [=a-group:v8:gv =_cor]
      =/  =action:v8:gv  [0v0 %group flag a-group]
      ^$(+< group-action-5+!>(action))
    ::
        ::  deprecated
        %group-leave
...
::
++  go-core
  |_  [=flag:g =net:g =group:g =request-id:v8:gv gone=_|]
  +*  ad  admissions.group
  ::
  ++  go-core  .
