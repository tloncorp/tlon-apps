...
::
::  compile all marks
::XX this is not actually compiling??
:: /~  marks  *  /mar/channel
::
=/  verbose  |
%-  %-  agent:neg
...
++  poke
  ...
  ::
    ...
    ::  upconvert emoji
    ::
    =?  a-channel.a-channels  ?=([%post %add-react *] a-channel.a-channels)
      %_  a-channel.a-channels
        q.c-post
        ...
        u.react
      ==
    =?  a-channel.a-channels  ?=([%post %reply @ %add-react *] a-channel.a-channels)
      %_  a-channel.a-channels
        q.c-reply.c-post
