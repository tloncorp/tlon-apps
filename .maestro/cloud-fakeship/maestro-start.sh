...
PROOF_PUBLIC_URL="$url" NODE_OPTIONS=--conditions=tlon-source pnpm --filter @tloncorp/tlon-bot-e2e exec tsx "$PWD/.maestro/cloud-fakeship/maestro-peer.ts" > "$PROOF_OUTPUT/peer.log" 2>&1 &
