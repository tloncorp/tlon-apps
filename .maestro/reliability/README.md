...
folder, and filters invalid folder-move destinations while keeping Root and a
valid peer destination visible. It also exercises cancel and confirm on channel
